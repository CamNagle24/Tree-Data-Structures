...
val paren_depth_chars : char list -> int -> int option
val parens_balanced_string : string -> bool

val paren_depth_tree : char tree -> int -> int option
val parens_balanced_tree : char tree -> bool
